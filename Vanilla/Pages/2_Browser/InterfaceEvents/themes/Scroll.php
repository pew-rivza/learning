<?php $img_stub = "/Vanilla/assets/img/loader.svg"; ?>
<script src="/Vanilla/Code/2_Browser/InterfaceEvents/Scroll.js"></script>

<div class="theme">
    <h3 id="scroll">Прокрутка</h3>
    <div class="task">
        <div class="header">Задача 1</div>
        Допустим, у нас есть клиент с низкой скоростью соединения, и мы хотим сэкономить его трафик.
        Для этого необходимо не показывать изображения сразу, а заменять их на «макеты». Когда страница
        прокручивается до того положения, где пользователь может увидеть изображение – src заменяется
        на значение из data-src, и таким образом изображение загружается.
        <ul>
        Требования:
            <li>Как только изображение помещается в визимую часть родительского элемента,
                оно загружается</li>
            <li>Некоторые изображения могут быть обычными, без data-src. Код не должен
                касаться их.</li>
            <li>Если изображение один раз загрузилось, оно не должно больше перезагружаться
                при прокрутке.</li>
            <li>Достаточно обрабатывать вертикальную прокрутку, горизонтальную не требуется.</li>
        </ul>
        ...
        <div id="lazy-images">
            ...
            <img src="https://ru.js.cx/clipart/solar/planets.jpg"
                 alt=""
            ...
            <img src="<?= $img_stub ?>"
                 alt=""
                 data-src="https://ru.js.cx/clipart/solar/sun.jpg"
            ...
            <img src="<?= $img_stub ?>"
                 alt=""
                 data-src="https://ru.js.cx/clipart/solar/mercury.jpg"
                 width="390" height="390">
            ...
            <img src="<?= $img_stub ?>"
                 alt=""
                 data-src="https://ru.js.cx/clipart/solar/venus.jpg"
                 width="390" height="390">
            ...
            <img src="<?= $img_stub ?>"
                 alt=""
                 data-src="https://ru.js.cx/clipart/solar/earth.jpg"
                 width="390" height="390">
            ...
            <img src="<?= $img_stub ?>"
                 alt=""
                 data-src="https://ru.js.cx/clipart/solar/mars.jpg"
                 width="390" height="390">
            ...
            <img src="<?= $img_stub ?>"
                 alt=""
                 data-src="https://ru.js.cx/clipart/solar/jupiter.jpg"
                 width="390" height="390">
            ...
            <img src="<?= $img_stub ?>"
                 alt=""
                 data-src="https://ru.js.cx/clipart/solar/saturn.jpg"
            ...
            <img src="<?= $img_stub ?>"
                 alt=""
                 data-src="https://ru.js.cx/clipart/solar/uranus.jpg"
                 width="390" height="390">
            ...
            <img src="<?= $img_stub ?>"
                 alt=""
                 data-src="https://ru.js.cx/clipart/solar/neptune.jpg"
                 width="390" height="390">
        </div>
    </div>
</div>