<script src="/Vanilla/Code/2_Browser/InterfaceEvents/MouseMoving.js"></script>
...
<div class="theme">
    ...
    <div class="task">
        ...
        <div data-tooltip="Здесь домашний интерьер" id="house">
            ...
            <p>Но вот наступила осень. Солнце уже не так сильно припекало, серые облака
                тянулись над пожелтевшим лесом.</p>
